...
static addViewCount(builder:flatbuffers.Builder, viewCount:number) {
  builder.addFieldFloat64(3, viewCount, 0.0);
}
...
static createPost(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, titleOffset:flatbuffers.Offset, published:boolean, viewCount:number, authorIdOffset:flatbuffers.Offset):flatbuffers.Offset {
