...
static addAge(builder:flatbuffers.Builder, age:number) {
  builder.addFieldFloat64(2, age, 0.0);
}
...
static createUser(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, age:number):flatbuffers.Offset {
