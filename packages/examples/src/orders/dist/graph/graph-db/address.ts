...
zip():string|null
zip(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
zip(optionalEncoding?:any):string|Uint8Array|null {
...
static addZip(builder:flatbuffers.Builder, zipOffset:flatbuffers.Offset) {
...
static createAddress(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, streetOffset:flatbuffers.Offset, cityOffset:flatbuffers.Offset, zipOffset:flatbuffers.Offset, customerIdsOffset:flatbuffers.Offset, createdAt:bigint, updatedAt:bigint):flatbuffers.Offset {
