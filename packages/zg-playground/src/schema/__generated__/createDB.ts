...
// --- Helper Types ---
type AnyZgNode = UserFB.User | PostFB.Post | CommentFB.Comment | FollowFB.Follow | Image_MetadataFB.Image_Metadata | ImageFB.Image | ReactionFB.Reaction | TagFB.Tag | PostTagFB.PostTag;
  ...
  get users() {
    return {
      get: (id: string): ResolvedNode<UserNode<TActor>, TEntityResolvers["User"], TGlobalResolvers> | null => {
        return this.db.get<UserFB.User, UserNode<TActor>>(
          'User',
          id,
          (db, fbb, ac) => new UserNode<TActor>(db, fbb, ac),
          (bb) => UserFB.User.getRootAsUser(bb),
  ...
  get posts() {
    return {
      get: (id: string): ResolvedNode<PostNode<TActor>, TEntityResolvers["Post"], TGlobalResolvers> | null => {
        return this.db.get<PostFB.Post, PostNode<TActor>>(
          'Post',
          id,
          (db, fbb, ac) => new PostNode<TActor>(db, fbb, ac),
          (bb) => PostFB.Post.getRootAsPost(bb),
  ...
  get comments() {
    return {
      get: (id: string): ResolvedNode<CommentNode<TActor>, TEntityResolvers["Comment"], TGlobalResolvers> | null => {
        return this.db.get<CommentFB.Comment, CommentNode<TActor>>(
          'Comment',
          id,
          (db, fbb, ac) => new CommentNode<TActor>(db, fbb, ac),
          (bb) => CommentFB.Comment.getRootAsComment(bb),
  ...
  get follows() {
    return {
      get: (id: string): ResolvedNode<FollowNode<TActor>, TEntityResolvers["Follow"], TGlobalResolvers> | null => {
        return this.db.get<FollowFB.Follow, FollowNode<TActor>>(
          'Follow',
          id,
          (db, fbb, ac) => new FollowNode<TActor>(db, fbb, ac),
          (bb) => FollowFB.Follow.getRootAsFollow(bb),
  ...
  get image_Metadatas() {
    return {
      get: (id: string): ResolvedNode<Image_MetadataNode<TActor>, TEntityResolvers["Image_Metadata"], TGlobalResolvers> | null => {
        return this.db.get<Image_MetadataFB.Image_Metadata, Image_MetadataNode<TActor>>(
          'Image_Metadata',
          id,
  ...
  get images() {
    return {
      get: (id: string): ResolvedNode<ImageNode<TActor>, TEntityResolvers["Image"], TGlobalResolvers> | null => {
        return this.db.get<ImageFB.Image, ImageNode<TActor>>(
          'Image',
          id,
          (db, fbb, ac) => new ImageNode<TActor>(db, fbb, ac),
          (bb) => ImageFB.Image.getRootAsImage(bb),
  ...
  get reactions() {
    return {
      get: (id: string): ResolvedNode<ReactionNode<TActor>, TEntityResolvers["Reaction"], TGlobalResolvers> | null => {
        return this.db.get<ReactionFB.Reaction, ReactionNode<TActor>>(
          'Reaction',
          id,
          (db, fbb, ac) => new ReactionNode<TActor>(db, fbb, ac),
          (bb) => ReactionFB.Reaction.getRootAsReaction(bb),
  ...
  get tags() {
    return {
      get: (id: string): ResolvedNode<TagNode<TActor>, TEntityResolvers["Tag"], TGlobalResolvers> | null => {
        return this.db.get<TagFB.Tag, TagNode<TActor>>(
          'Tag',
          id,
          (db, fbb, ac) => new TagNode<TActor>(db, fbb, ac),
          (bb) => TagFB.Tag.getRootAsTag(bb),
  ...
  get postTags() {
    return {
      get: (id: string): ResolvedNode<PostTagNode<TActor>, TEntityResolvers["PostTag"], TGlobalResolvers> | null => {
        return this.db.get<PostTagFB.PostTag, PostTagNode<TActor>>(
          'PostTag',
          id,
