...
export function generateMutationHelpers(schema) {
    const lines = [];
    ...
    for (const nodeType of nodeTypes) {
        ...
        lines.push(`  ${nodeType}: (data: { fields: ${capNodeType}Data['fields'], relationIds: ${capNodeType}Data['relationIds'] }): ${capNodeType}Data => {`);
