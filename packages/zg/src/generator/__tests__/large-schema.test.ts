...
describe("FBS Generator: Comprehensive Integration Test", () => {
  it("should generate a correct FBS schema for a large, complex social network model", () => {
    // --- Schema Definitions ---
    ...
    const fbsContent = generateFbs(normalized);

    // --- Verification ---
    const snapshotPath = "./__snapshots__/SocialNetwork.fbs.snap";
