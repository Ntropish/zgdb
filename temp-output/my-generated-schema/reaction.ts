...
static createReaction(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, authorOffset:flatbuffers.Offset, targetIdOffset:flatbuffers.Offset, targetTypeOffset:flatbuffers.Offset):flatbuffers.Offset {
  Reaction.startReaction(builder);
  Reaction.addId(builder, idOffset);
  Reaction.addType(builder, typeOffset);
  Reaction.addAuthor(builder, authorOffset);
